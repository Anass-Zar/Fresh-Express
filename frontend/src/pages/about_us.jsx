...
const About_US = () => {
  ...
  // const lng = cookies.get("i18next") || "English";
  ...
  return (
    <div>
      ...
      <div>
        <div
          className="w-full h-40 md:h-52 text-center grid items-center content-center font-[Dosis] uppercase"
          style={{
            backgroundImage: `url(${vfImage})`,
        ...
        >
          <div className="w-full h-40 md:h-52 py-16 text-center grid items-center content-center bg-[#16A34Add]">
            ...
            {/* <h1 className="text-3xl md:text-5xl font-bold text-gray-50 text-center">{t("about_us.Title")}</h1> */}
        ...
        <div className="block px-6 pb-10 pt-8 md:pb-20 md:py-16 md:px-10 ">
          ...
          <div className="mx-auto max-w-5xl text-center">
            ...
            <p className="mx-auto my-4 w-full max-w-xl bg-transparent text-center font-medium leading-relaxed tracking-wide text-gray-700">
              At Fresh Express we are passionate about delivering the freshest and most delicious fruits and 
              vegetables directly to your doorstep. Our mission is to make it easy and convenient for you to enjoy the goodness of nature&apos;s bounty.
              {/* {t("about_us.P")} */}
            </p>
          ...
          <div className="mx-auto max-w-7xl z-10 grid grid-cols-1 gap-10 pt-14 sm:grid-cols-2 lg:grid-cols-3">
            <div className="rounded-md border border-green-600 p-8 text-center shadow">
              ...
              <p className="my-4 mb-0 font-normal leading-relaxed tracking-wide">
                We source our fruits from the finest farms and ensure that only the best produce reaches your table. Quality is our top priority, 
                and we guarantee freshness with every delivery.
              </p>
              {/* <h3 className="mt-6 font-semibold text-lg">{t("about_us.T1")}</h3>
              <p className="my-4 mb-0 font-normal leading-relaxed tracking-wide">{t("about_us.P1")}</p> */}
            </div>
            ...
            <div className="rounded-md border border-green-600 p-8 text-center shadow">
              ...
              <p className="my-4 mb-0 font-normal leading-relaxed tracking-wide">
                Fruits & Website was founded with a simple idea: to make fresh, high-quality fruits accessible to everyone. Since then, we have grown 
                into a trusted name in the industry, known for our commitment to excellence and customer satisfaction.
              </p>
              {/* <h3 className="mt-6 font-semibold text-lg">{t("about_us.T2")}</h3>
              <p className="my-4 mb-0 font-normal leading-relaxed tracking-wide">{t("about_us.P2")}</p> */}
            </div>
            ...
            <div className="rounded-md border border-green-600  p-8 text-center shadow">
              ...
              <p className="my-4 mb-0 font-normal leading-relaxed tracking-wide">
                Our vision is to become the go-to destination for fresh, high-quality fruits. We strive to create a seamless shopping experience for 
                our customers, providing them with the freshest produce and the best customer service.
              </p>
              {/* <h3 className="mt-6 font-semibold text-lg">{t("about_us.T3")}</h3>
              <p className="my-4 mb-0 font-normal leading-relaxed tracking-wide">{t("about_us.P3")}</p> */}
            </div>
          </div>
