      ...
      <Navbar />
        ...
        <div className='w-full grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-0 pt-14 md:pt-20 pb-10 lg:px-20 xl:px-32'>
          <div className='grid justify-items-center gap-1 md:gap-2'>
            ...
            <p className='text-lg text-gray-700'>+212 722-029-078</p>
          </div>
          <div className='grid justify-items-center gap-1 md:gap-2'>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className='w-10 h-10 md:w-12 md:h-12'>
            ...
            <p className='text-lg text-gray-700'>anasszarioh10@gmail.com</p>
          </div>
          <div className='grid justify-items-center gap-1 md:gap-2'>
            ...
            <p className='text-lg text-gray-700 text-center'>Hay Mohammady, Agadir, Morocco</p>
          </div>
        </div>
            ...
            <div className="bg-white rounded-lg px-6 py-10 md:px-10 md:py-16">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                <form ref={form} onSubmit={sendEmail} className="grid gap-4">
                  <div className="">
                    <label htmlFor="user_name" className="font-semibold">Full Name</label>
                    <input type="text" name="user_name" id="user_name" value={user_name}
                      onChange={(e) => setUser_name(e.target.value)} className="h-10 border mt-1 rounded px-3 w-full border-gray-300 bg-white focus:outline-none focus:border-green-500 focus:bg-white" placeholder="Full Name" />
                  </div>
                  <div className="">
                    ...
                    <input type="text" name="user_email" id="user_email" value={user_email}
                      onChange={(e) => setUser_email(e.target.value)} className="h-10 border mt-1 rounded px-3 w-full border-gray-300 bg-white focus:outline-none focus:border-green-500 focus:bg-white" placeholder="Email" />
                  </div>
                  <div className="">
                    <label htmlFor="message" className="font-semibold">Message</label>
                    <textarea name="message" id="message" rows="5" value={message} onChange={(e) => setMessage(e.target.value)}
                    placeholder="Your Message" className="h-32 border mt-1 rounded px-3 w-full border-gray-300 bg-white focus:outline-none focus:border-green-500 focus:bg-white" />
                  </div>
