          ...
          >
            ...
            <div className="absolute inset-0 flex justify-center items-center bg-black/20">
              <div className="grid justify-items-center gap-10">
                ...
                <Link to="/about_us" className="text-md md:text-lg lg:text-xl font-semibold text-white py-2 px-4 bg-green-500 hover:bg-green-400 rounded-3xl">Read More</Link>
              </div>
            </div>
          </div>
        ))}
